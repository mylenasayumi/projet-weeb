        ...
        <section className="my-20 p-2">
            <div className="container max-w-screen-2xl mx-auto flex flex-col lg:flex-row justify-between items-center px-8 md:px-16 gap-12">
                <div className="flex-1 space-y-6">
                    <p className="text-xl font-bold">RESOURCES FOR ALL LEVELS</p>
                    <h1 className="text-light-purple md:text-7xl text-5xl font-extrabold">Learn <span className="text-white">and</span> progress</h1>
                    <p className="text-lg font-normal">Whether you are a beginner in web development or an expert looking to deepen your knowledge, we offer tutorials, guides and best practices to help you learn effectively.</p>
