...
const login = {
    ...
    createAccountText: "You don't have an account? You can ",
    createAccountButton: "create one",
    orDivider: "or",
    githubButton: "Continue with GitHub",
    accountCreatedMessage: "Your account has been successfully created. It must be activated by an administrator.",
